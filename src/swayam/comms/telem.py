# blasts udp packets into the void and hopes someone is listening
# if the network is bad, good luck lmao
...
class SwarmTelemetry:
    ...
    def broadcast_status(self, lat, lon, alt, battery, status):
        # TODO: migrate to dataclasses like navcore, this dict unpacking is horrible
        data = {'id': self.drone_id, 'ts': time.time(), 'lat': lat, 'lon': lon, 'alt': alt, 'bat': battery, 'stat': status}
